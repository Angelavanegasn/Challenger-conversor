package Challenger.Conversor.app;


import java.util.Scanner;
   

import Challenger.Conversor.util.Apariencia;
import Challenger.Conversor.config.Conexion;
import Challenger.Conversor.model.EntradaNumerica;
import Challenger.Conversor.util.Header;
import Challenger.Conversor.config.MonedaConvertida;
import Challenger.Conversor.config.ResultadoConversionMoneda;
